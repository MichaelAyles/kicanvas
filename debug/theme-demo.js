...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const kicanvasThemeSelector = document.getElementById(
        "kicanvas-theme-selector",
    );
    ...
    function getEffectiveKiCanvasTheme() {
        if (currentKiCanvasMode === "page") {
            // Follow page theme
            const effectivePageTheme =
                currentPageTheme === "auto"
    ...
    function initializeThemes() {
        ...
        const savedPageTheme =
            localStorage.getItem("kicanvas-demo-page-theme") || "light";
        const savedKiCanvasMode =
            localStorage.getItem("kicanvas-demo-kicanvas-mode") || "kicad";
    ...
    function saveThemePreferences() {
        localStorage.setItem(
            "kicanvas-demo-page-theme",
            pageThemeSelector.value,
        );
        localStorage.setItem(
            "kicanvas-demo-kicanvas-mode",
            kicanvasThemeSelector.value,
        );
    }
